...
const WhatsAppButton = () => {
  const phone = "919XXXXXXXXX"; // replace with actual number e.g. 919876543210
  ...
  return (
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] rounded-full flex items-center justify-center shadow-2xl transition-all hover:scale-110"
