...
const trustItems = [
  ...
  { icon: '⚙️', text: 'CNC Precision Machining' },
  { icon: '🚚', text: 'Export-Ready Dispatch' },
];
    ...
    <div className="mt-10">
      <div className="flex flex-col gap-1.5">
        {data.stages.map((s, i) => {
          ...
          return (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.06 }} className="rounded-2xl overflow-hidden">
              <button
                onClick={() => select(i)}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    <span className="text-[10px] font-bold uppercase tracking-[1.5px] transition-colors" style={{ color: isOpen ? col : '#9ca3af' }}>{s.num}</span>
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-3xl lg:text-5xl font-black text-charcoal leading-tight mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Inside the HAVA{' '}
                <span className="gradient-text">25,000 Sq. Ft. Manufacturing Facility</span>
              </h1>
      ...
      <section className="relative py-10 lg:py-14 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader badge="Factory Overview" badgeColor="hava-red" badgeIcon={Factory} title="MIDC Pimpri" titleGradient="Manufacturing Plant" intro={d.factoryOverview.body} />

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
            {d.factoryOverview.cards.map((card, i) => (
              <motion.div key={i} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: i * 0.05 }} className="bg-gradient-to-br from-slate-50 to-blue-50 border-l-4 border-hava-red rounded-2xl p-5 hover:shadow-xl transition-all group">
      ...
      <section className="relative py-10 lg:py-14 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
        <AnimatedBackground />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader badge="Manufacturing Process Chart" badgeColor="trust-blue" badgeIcon={Settings} title="Eight Stages." titleGradient="Zero Compromise." intro={d.processChart.body} />
      ...
      <section className="relative py-10 lg:py-14 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader badge="Quality Standards" badgeColor="hava-red" badgeIcon={ShieldCheck} title="What We Inspect —" titleGradient="And When" intro={d.qcStandards.body} />
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="mt-10 rounded-3xl overflow-hidden shadow-2xl border-2 border-steel-gray">
            ...
            {d.qcStandards.rows.map((row, i) => (
              <motion.div key={i} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.3, delay: i * 0.05 }} className={`grid grid-cols-1 md:grid-cols-12 border-t border-steel-gray ${i % 2 === 0 ? 'bg-slate-50/60' : 'bg-white'}`}>
                <div className="md:col-span-3 p-4 font-bold text-charcoal text-sm md:border-r border-steel-gray flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-hava-red flex-shrink-0 mt-0.5" />{row.type}
                </div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <Button onClick={() => setQuoteModalOpen(true)} className="bg-accent-orange hover:bg-accent-orange/90 text-charcoal font-bold px-6 py-3 rounded-xl">Get a Quote</Button>
            </div>
          </motion.div>
        </div>
      </section>
