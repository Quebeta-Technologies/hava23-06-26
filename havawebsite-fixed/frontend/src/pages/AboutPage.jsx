  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <PageHero
        ...
        title="Engineering Rock Drilling"
        titleGradient="Excellence Since 1970"
        body={d.hero.body}
      >
        {/* Stats inline */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 max-w-4xl mx-auto mt-4">
          {d.hero.stats.map((stat, i) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-md border-2 border-steel-gray rounded-2xl p-4 shadow-lg"
            >
              <div className="text-xl lg:text-2xl font-black text-charcoal">{stat.value}</div>
              <div className="text-[10px] lg:text-xs text-gray-600 uppercase tracking-wider mt-1">{stat.label}</div>
            </motion.div>
          ))}
        </div>
      </PageHero>
      ...
      {/* COMPANY OVERVIEW */}
      <section className="relative py-12 lg:py-16 overflow-hidden bg-white" id="overview">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Sub-Page 1 of 5"
            badgeColor="hava-red"
            title="Company"
            titleGradient="Overview"
          />

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
            {/* LEFT 2 cols — Intro + brand story */}
            <motion.div
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-gradient-to-br from-charcoal to-trust-blue rounded-3xl p-7 text-white relative overflow-hidden"
            >
              ...
              <div className="relative">
                ...
                <a
                  href={d.companyOverview.address.mapLink}
                  target="_blank"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
            <motion.div
              ...
              className="bg-white border-2 border-hava-red/20 rounded-3xl p-7 shadow-lg hover:shadow-2xl transition-all relative overflow-hidden"
            >
            ...
            <motion.div
              ...
              className="bg-white border-2 border-trust-blue/20 rounded-3xl p-7 shadow-lg hover:shadow-2xl transition-all relative overflow-hidden"
            >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {d.companyOverview.capabilityCards.map((c, i) => (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-slate-50 to-blue-50 border-l-4 border-hava-red rounded-2xl p-5 hover:shadow-xl transition-all"
                >
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50" id="journey">
        <AnimatedBackground />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Sub-Page 2 of 5"
            badgeColor="hava-red"
            badgeIcon={Calendar}
            title="Our"
            titleGradient="Journey / Timeline"
            intro={d.journey.intro}
          />
              ...
              {d.journey.timeline.map((t, i) => (
                ...
                >
                  ...
                  <div className={`mt-4 bg-white rounded-2xl p-5 border-t-4 shadow-md hover:shadow-2xl transition-all text-center ${t.highlighted ? 'border-hava-red' : 'border-steel-gray'}`}>
                    <div className={`text-2xl font-black mb-2 ${t.highlighted ? 'text-hava-red' : 'text-trust-blue'}`}
      ...
      {/* LEADERSHIP */}
      <section className="relative py-12 lg:py-16 overflow-hidden bg-white" id="leadership">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Sub-Page 3 of 5"
            badgeColor="hava-red"
            badgeIcon={Briefcase}
            title="Leadership"
            titleGradient="Team"
            intro={d.leadership.intro}
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-6xl mx-auto mt-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-3xl p-7 border-2 border-steel-gray shadow-lg hover:shadow-2xl transition-all relative overflow-hidden"
            >
              ...
              <div className="relative">
                <div className="flex items-start gap-4 mb-5">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-charcoal mt-1" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                      {d.leadership.founder.name}
                    </h3>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {d.leadership.founder.tags.map((tag, i) => (
                    <span key={i} className="text-xs font-bold uppercase tracking-wider bg-white border border-steel-gray px-3 py-1.5 rounded-full text-charcoal">
                      {tag}
                    </span>
                  ))}
                </div>
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="space-y-3 mb-5">
                  <a href={`tel:${d.leadership.contact.phone1}`} className="flex items-center gap-3 text-white/90 hover:text-accent-orange text-sm transition-colors">
                    <Phone className="w-4 h-4" /> {d.leadership.contact.phone1}
                  </a>
                  <a href={`tel:${d.leadership.contact.phone2}`} className="flex items-center gap-3 text-white/90 hover:text-accent-orange text-sm transition-colors">
                    <Phone className="w-4 h-4" /> {d.leadership.contact.phone2}
                  </a>
                  <a href={`mailto:${d.leadership.contact.email}`} className="flex items-center gap-3 text-white/90 hover:text-accent-orange text-sm transition-colors">
                    <Mail className="w-4 h-4" /> {d.leadership.contact.email}
                  </a>
                </div>
                ...
                <a
                  href={d.leadership.contact.mapLink}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 text-accent-orange hover:text-white text-sm font-bold group transition-colors"
                >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="max-w-5xl mx-auto mt-10 bg-gradient-to-br from-hava-red/5 via-white to-accent-orange/5 border-l-4 border-hava-red rounded-r-3xl p-8 lg:p-10 relative"
          >
            <QuoteIcon className="absolute top-6 right-8 w-16 h-16 text-hava-red/10" />
            <p className="text-lg lg:text-xl text-charcoal leading-relaxed italic mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              "{d.leadership.quote}"
            </p>
      ...
      {/* CERTIFICATIONS */}
      <section className="relative py-12 lg:py-16 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50" id="certifications">
        <AnimatedBackground />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge="Sub-Page 5 of 5"
            badgeColor="hava-red"
            badgeIcon={ShieldCheck}
            title="Certifications &"
            titleGradient="Compliance"
            intro={d.certifications.intro}
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-white rounded-3xl border-2 border-steel-gray shadow-xl overflow-hidden"
            >
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h3 className="text-lg font-black text-charcoal" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Compliance & <span className="gradient-text">Export Standards</span>
              </h3>
              {d.certifications.compliance.map((c, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.4, delay: i * 0.1 }}
                  className="bg-white border-l-4 border-hava-red rounded-r-2xl p-5 shadow-md hover:shadow-xl transition-all flex items-start gap-3"
                >
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge={d.promise.label}
            badgeColor="hava-red"
            badgeIcon={Sparkles}
            title="Dependable Rock Drilling Solutions."
            titleGradient="Every Time. Every Year."
            intro={d.promise.body}
          />
            ...
            {d.promise.cards.map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: i * 0.1 }}
                  className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-3xl p-6 border-2 border-steel-gray hover:border-hava-red/40 shadow-md hover:shadow-2xl transition-all card-hover group"
                >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  ...
                  variant="outline"
                  className="border-2 border-white/30 text-white hover:bg-white/10 font-bold px-8 py-6 text-base rounded-xl w-full sm:w-auto"
                >
                  Explore Products
                </Button>
              </motion.div>
