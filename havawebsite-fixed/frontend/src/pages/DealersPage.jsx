...
export const DealersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* HERO */}
      <PageHero
        eyebrow={dealersData.hero.eyebrow}
        title={dealersData.hero.title}
        titleGradient={dealersData.hero.titleGradient}
        body={dealersData.hero.body}
      >
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 max-w-4xl mx-auto mt-4 mb-6">
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge={dealersData.philosophy.label}
            badgeColor="hava-red"
            badgeIcon={Briefcase}
            title={dealersData.philosophy.title}
            titleGradient={dealersData.philosophy.titleGradient}
            intro={dealersData.philosophy.body}
          />
          {/* Pull quote */}
          <motion.div
            ...
            className="max-w-4xl mx-auto mt-10 bg-gradient-to-br from-hava-red/5 via-white to-accent-orange/5 border-l-4 border-hava-red rounded-r-3xl p-8 lg:p-10 relative"
          >
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge={dealersData.reasons.label}
            badgeColor="accent-orange"
            badgeIcon={Sparkles}
            title={dealersData.reasons.title}
            titleGradient={dealersData.reasons.titleGradient}
          />
            ...
            {dealersData.reasons.cards.map((card, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-3xl p-6 border-2 border-steel-gray hover:border-hava-red/40 shadow-md hover:shadow-2xl transition-all card-hover group relative overflow-hidden"
                >
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge={dealersData.idealPartners.label}
            badgeColor="trust-blue"
            badgeIcon={Users}
            title={dealersData.idealPartners.title}
            titleGradient={dealersData.idealPartners.titleGradient}
          />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
            {dealersData.idealPartners.cards.map((c, i) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-slate-50 to-blue-50 border-l-4 border-accent-orange rounded-r-2xl p-5 hover:shadow-xl transition-all group"
              >
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader
            badge={dealersData.enquiry.label}
            badgeColor="hava-red"
            badgeIcon={Mail}
            title={dealersData.enquiry.title}
            titleGradient={dealersData.enquiry.titleGradient}
            intro={dealersData.enquiry.body}
          />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="space-y-2 pt-4 border-t border-white/10 mb-4">
                  <a href={`tel:${dealersData.enquiry.address.phone}`} className="flex items-center gap-2 text-white/90 hover:text-accent-orange text-sm transition-colors">
                    <Phone className="w-4 h-4" /> {dealersData.enquiry.address.phone}
                  </a>
                  <a href={`mailto:${dealersData.enquiry.address.email}`} className="flex items-center gap-2 text-white/90 hover:text-accent-orange text-sm transition-colors">
                    <Mail className="w-4 h-4" /> {dealersData.enquiry.address.email}
                  </a>
                </div>
                <a
                  href={dealersData.enquiry.address.mapLink}
                  target="_blank"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-white rounded-3xl p-7 border-2 border-steel-gray shadow-xl"
            >
              ...
              <h3 className="font-black text-charcoal text-lg mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                Required Information
              </h3>
              <div className="grid grid-cols-2 gap-2 mb-5">
                {dealersData.enquiry.formFields.map((field, i) => (
                  <div key={i} className="text-xs text-charcoal bg-slate-50 px-3 py-2 rounded-lg border border-steel-gray">
                    • {field}
                  </div>
                ))}
              </div>
              <Button
                onClick={() => setQuoteModalOpen(true)}
                className="w-full bg-gradient-to-r from-hava-red to-accent-orange hover:from-hava-red/90 hover:to-accent-orange/90 text-white font-bold py-6 text-base shadow-xl rounded-xl group"
              >
      ...
      <section className="relative py-12 lg:py-16 overflow-hidden bg-charcoal">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-base lg:text-lg text-white/70 mb-8 max-w-2xl mx-auto">{dealersData.finalCta.body}</p>
