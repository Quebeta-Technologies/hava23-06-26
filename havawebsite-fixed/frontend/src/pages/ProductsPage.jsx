            ...
            return (
              <div key={ri} className="bg-white rounded-2xl border-2 border-steel-gray hover:border-hava-red/40 hover:shadow-xl transition-all overflow-hidden">
                <div className="flex flex-col sm:flex-row">
                  ...
                  {/* LEFT: Product Image */}
                  <div className="w-64 flex-shrink-0 bg-gradient-to-br from-slate-100 to-blue-50 flex items-center justify-center overflow-hidden h-[280px] lg:h-auto" style={{ minHeight: '220px' }}>
