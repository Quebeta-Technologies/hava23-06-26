...
const CategoryContent = ({ cat, onEnquire }) => {
  ...
  const renderProducts = () => {
    if (cat.code === 'A') {
      ...
      const videos = ["/products/Rock Drill Spade Handle (1).mp4", null]; // e.g. '/videos/rock-drill-1.mp4' — add when ready
      return (
            ...
            return (
              <div key={ri} className="bg-white rounded-2xl border-2 border-steel-gray hover:border-hava-red/40 hover:shadow-xl transition-all overflow-hidden">
                <div className="flex flex-col sm:flex-row">
                  ...
                  {/* LEFT: Product Image */}
                  <div className="w-64 flex-shrink-0 bg-gradient-to-br from-slate-100 to-blue-50 flex items-center justify-center overflow-hidden" style={{ minHeight: '220px', maxHeight: '280px' }}>
                    <img src={images[ri]} alt={row[0]} className="w-full h-full object-cover" style={{ minHeight: '220px', maxHeight: '280px' }} />
                  </div>
